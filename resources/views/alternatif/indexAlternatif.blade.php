                    ...
                    <div id="crud-modal" tabindex="-1" aria-hidden="true"
                        ...
                        <div class="relative p-4 w-full max-w-md max-h-full">
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <form class="p-4 md:p-5" method="post" action="{{ route('data-alternatif.store') }}"
                                    ...
                                    <div class="mb-4">
                                        <label for="total_luas_tanah"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Total Luas
                                            Tanah</label>
                                        <input type="text" name="total_luas_tanah" id="total_luas_tanah"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                            readonly>
                                    </div>
                                ...
                                <td class="text-center py-4">
                                    <div class="md:flex justify-around">
                                        <div class="flex items-center">
                                            ...
                                            <button data-modal-target="crud-modal-{{ $Alternatif->id }}"
                                                data-modal-toggle="crud-modal-{{ $Alternatif->id }}"
                                                class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                                type="button">
                                                Edit
                                            </button>
                                            <div id="crud-modal-{{ $Alternatif->id }}" tabindex="-1" aria-hidden="true"
                                                class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                                <div class="relative p-4 w-full max-w-md max-h-full">
                                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                        <div
                                                        ...
                                                        <form class="p-4 md:p-5" method="post"
                                                            action="{{ route('data-alternatif.update', $Alternatif->id) }}"
                                                            id="myForm" enctype="multipart/form-data">
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="grid gap-4 mb-4 grid-cols-2">
                                        ...
                                        <button type="submit" data-modal-target="popup-modal-{{ $Alternatif->id }}"
                                            data-modal-toggle="popup-modal-{{ $Alternatif->id }}"
                                            class="bg-red-500 hover:bg-red-600 text-primary font-medium rounded-lg text-sm px-5 py-2.5 text-center"
                                            type="submit">
                                            Hapus
                                        </button>
                                        <div id="popup-modal-{{ $Alternatif->id }}" tabindex="-1"
                                            class="fixed top-0 left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                            <div class="relative w-full max-w-md max-h-full">
                                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                    <button type="button"
                                                        class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white"
                                                        data-modal-hide="popup-modal-{{ $Alternatif->id }}">
                                                    ...
                                                    <div class="p-6 text-center space-x-10">
                                                        ...
                                                        <button data-modal-hide="popup-modal-{{ $Alternatif->id }}"
                                                            type="button"
